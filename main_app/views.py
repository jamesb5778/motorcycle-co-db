...
# class to view all the motorcycles from all the companies 
class Motorcycle_Model_List(TemplateView):
    template_name = "motorcycle_model_list.html"
...
class Motorcycle_Model_Details(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["mc_models"] = []
        return context
# class to add Motorcycle Models onto the
